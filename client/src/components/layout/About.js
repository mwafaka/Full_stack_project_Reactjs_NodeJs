...
const about = () => {
  return (
    ...
    <div style={font}>
       <div>
        <a  style={styles} href="#p1"><img style={image}  src={require("./img/06.jpg")} alt="Mwafak"/>
        </a>
        <div className="about-top   p-2 text-primary" style={{display:"flex"}}>
        <a href="" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.linkedin.com/in/mwafak-arbash-5355b9167/" target="_blank" rel="noopener noreferrer">
           <i class="fab fa-linkedin fa-2x p-2"></i>
          </a>
           <a href="https://github.com/mwafaka" target="_blank" rel="noopener noreferrer">
        ...
        <span style={name}>Mwafak Abrash</span>
         ...
         <div>
        <a style={styles} href="#p2"><img style={image}  src={require("./img/04.jpg")} alt="Nasseb"/></a>
        <div className="about-top   p-2 text-primary" style={{display:"flex"}}>
        <a href="" target="_blank" rel="noopener noreferrer">
            <i className="fab fa-twitter fa-2x p-1" />
          </a> 
